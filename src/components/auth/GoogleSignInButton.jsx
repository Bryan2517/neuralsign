 ...
 * Branded Google sign-in button with loading state
 */
 ...
 */
const GoogleSignInButton = ({ onClick, isLoading: parentLoading, className }) => {
    ...
    return (
        <button
            ...
            className={cn(
                ...
                'hover:bg-dark-700 hover:border-dark-500 hover:text-dark-100',
